...
const Header = () => {
  return (
    <div className="py-1 sticky top-0 px-4 flex justify-between bg-[#EEF3F0]">
      <div>
        <img
      ...
      <div className="flex gap-x-10 ">
        ...
        <button className="rounded-full">
          <img src={userplus} alt="image" className="h-9 w-9 bg-transparent rounded-full p-2 border-[#e4ebe6] border-2" />
        </button>
