          ...
          <div className="font-Ubuntu text-white ">
            <div className="flex justify-center px-10 mt-2  items-center w-full">
              <input
                ...
                className="w-full h-14 text-lg rounded-full border-green border-2 bg-transparent p-2 px-3 hover:shadow-none transition-all hover:translate-x-[3px] shadow-[4px_4px_0px_rgb(153,255,82)] hover:border hover:translate-y-[3px] "
              />
            </div>
            ...
            <div className="flex ml-8  mr-36 flex-col justify-center items-center mt-4">
              <ul className="flex   flex-col  w-full gap-y-">
                ...
                <li className="flex cursor-pointer gap-x-2 p-2 hover:bg-secondary h-20">
                  ...
                  <div className="flex justify-center items-center ml-4">
                    <h2 className="text-xl font-semibold text-center ">
                      Idea Dojo: Hone your next hackathon project from concept
                      to reality.
                    </h2>
                  </div>
                </li>
